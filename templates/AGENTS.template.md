...
> 本仓库采用 [Harness Engineering]({{VENDOR_DIR}}/HANDBOOK.md) 作为工程骨架。
...
- 操作手册：[`{{VENDOR_DIR}}/HANDBOOK.md`]({{VENDOR_DIR}}/HANDBOOK.md)
- 阶段细则（H1–H6）：[`{{VENDOR_DIR}}/docs/stages/`]({{VENDOR_DIR}}/docs/stages/)
- 需求 / 设计 / 测试 / 任务 / 评审：`docs/01-requirements/` … `docs/07-reviews/`
- 模板与 Skill：`.github/templates/` 与 `.github/skills/`
- 多语言代码风格：[`{{VENDOR_DIR}}/docs/instructions-layout.md`]({{VENDOR_DIR}}/docs/instructions-layout.md)
