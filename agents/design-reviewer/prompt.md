...
1. 严格遵循 [Harness Engineering 规范](../../README.md) 与 [`docs/stages.md`](../../docs/stages.md) 第 6 节（H3 章节）。
...
- 验证 `docs/04-detailed-design/` 下至少有 [`docs/stages.md`](../../docs/stages.md) 第 6 节列出的核心章节文件

任一不满足，按 [io-contracts.md 第 5 节](../_shared/io-contracts.md) 阻塞返回。

### 第二步：完备性扫描

按 [`docs/stages.md`](../../docs/stages.md) 第 6 节列出的章节逐项检查 `docs/04-detailed-design/` 下对应文件：
...
- 设计目录严重偏离 [`docs/stages.md`](../../docs/stages.md) 第 6 节阻塞返回时给出明确的 `suggested_next_action`，不要尝试用部分数据写"半个报告"。
